  ...
  return (
    <StyledRegisterForm>
        ...
        <div className="register_header">
            ...
            <p className="register_description">Already have an account?
            <Link to="/" onClick={()=>{handleClickLogin(); handleClickRegister();}}> Log in </Link>
            </p>
        </div>
            ...
            <form action="" ref={form} onSubmit={handleSubmit}>
                ...
                <div className="form_group">
                    <label className="form-label form-label-checkbox" htmlFor="ip_rememberme">
                        <input type="checkbox" id="checkbox" className="form-checkbox" onChange={handleChange} name="checkbox" value="yes" required/>
                        <label htmlFor="checkbox">Yes, I agree with Privacy Policy and Terms of Use</label>
                    </label>
                </div>
