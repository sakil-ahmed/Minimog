...
export const ForgetPass = ({handleClickReset , handleClickLogin}) => {
    ...
    const onChange = e => setReset({ ...reset , [e.target.name] : e.target.value});
  ...
  return (
    <StyledForgetPass>
        ...
        <div className="reset_header">
            ...
            Please enter your username or email address. You will receive a link to create a new password via email. Remember now?
            <Link to="" onClick={()=>{handleClickLogin();handleClickReset()}}> Back to login</Link>
            </p>
        </div>
        <div className="lost-password-form">
            <form action="" ref={form} onSubmit={submitForm}>
            <div className="form_group">
                <input type="text" name="resetPassword" onChange={onChange} placeholder="Your username or email"/>
            </div>
            <div className="form_group">
